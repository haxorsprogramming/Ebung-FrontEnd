	...
	<div class="related">
		<div class="container">
			...
			<div class="product-image-category">
				<figure class="sale"><a href="#"><img src="img/340x420.png" class="img-responsive" alt="img-holiwood"></a></figure>
		...
		<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 product-category">
			<div class="product-image-category">
					<a href="#"><img src="img/340x420.png" class="img-responsive" alt="img-holiwood"></a>
					<div class="product-icon-category">
						<a href="#"><i class="far fa-eye"></i></a>
						<a href="#"><i class="fas fa-shopping-basket"></i></a>
						<a href="#"><i class="far fa-heart"></i></a>
		...
		<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 product-category">
			<div class="product-image-category">
				<figure class="hot"><a href="#"><img src="img/340x420.png" class="img-responsive" alt="img-holiwood"></a></figure>
					<div class="product-icon-category">
						<a href="#"><i class="far fa-eye"></i></a>
						<a href="#"><i class="fas fa-shopping-basket"></i></a>
						<a href="#"><i class="far fa-heart"></i></a>
